<template>
    <div class="mt-4">
        <!-- NOTE: LABEL -->
        <label class="block mb-1 text-sm font-medium text-brand-600 dark:text-neutral-300">{{ name }}</label>

        <!-- NOTE SWITCH -->
        <Switch
            v-model="enabled"
            :class="[
                enabled ? 'bg-brand-600 dark:bg-brand-500' : 'bg-gray-200 dark:bg-neutral-800',
