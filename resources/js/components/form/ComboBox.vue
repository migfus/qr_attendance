            ...
            <Combobox as="div" v-model="$model">
                ...
                <div class="relative mt-1">
                    ...
                    <ComboboxInput
                        ...
                        :displayValue="(row: any) => row?.name"
                        :placeholder
                        class="w-full rounded-xl border border-gray-300 dark:border-neutral-600 bg-white dark:bg-dark-001 py-2 pl-3 pr-10 focus:border-brand-500 focus:outline-hidden focus:ring-1 focus:ring-brand-500 sm:text-sm dark:text-brand-100"
                    />
                    ...
                    <ComboboxOptions
                        ...
                        class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-neutral-700 py-1 text-base shadow-lg ring-1 ring-brand-200 dark:ring-neutral-600 ring-opacity-5 focus:outline-hidden sm:text-sm"
                    >
                            ...
                            <li
                                :class="[
                                    ...
                                    selected
                                        ...
                                        : active
                                        ? 'bg-brand-600 text-white dark:bg-dark-003'
                                        : 'text-gray-900 dark:bg-dark-002 dark:text-neutral-300',
                                    'cursor-pointer'
                                ]"
                            >
...
const $model = defineModel<Select | null>()
