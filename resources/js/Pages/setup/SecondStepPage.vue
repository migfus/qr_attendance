    ...
    <SetupLayout :current_step="2">
        <form @submit.prevent="storeEnvFile()" class="flex flex-col gap-4 lg:col-start-2">
            ...
            <BasicCard title="Finalize" :icon="CheckIcon">
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col gap-2">
                        <InformationLabel> You can modify the .env after the setup. </InformationLabel>
                        <InformationLabel> Do not run on "php artisan serve", it will not run migration. </InformationLabel>
                        <InformationLabel> Double check everything before you proceed. </InformationLabel>
                    </div>
