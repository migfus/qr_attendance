        ...
        <BasicCard title="Check for Requirements" class="lg:col-start-2" :icon="CheckCircleIcon">
            <form @submit.prevent="submit()" class="flex flex-col gap-2">
                <div class="lg:grid grid-cols-2 gap-2 flex flex-col">
                    ...
                    <div class="flex flex-col gap-2 mt-4 lg:col-span-2">
                        <InformationLabel> If this can be too technical to fix, please ask experts. </InformationLabel>
                    </div>
                </div>
...
import { ArrowLeftIcon, ArrowPathIcon, ArrowRightIcon, CheckCircleIcon, InformationCircleIcon, XCircleIcon } from '@heroicons/vue/24/outline'
