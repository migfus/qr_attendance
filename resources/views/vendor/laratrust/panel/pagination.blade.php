    ...
    <div>
      <span class="relative z-0 inline-flex shadow-sm">
        <{!!$paginator->onFirstPage()
          ...
          !!}
          class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm leading-5 font-medium {{$paginator->onFirstPage() ? 'text-gray-500' : 'text-gray-700'}} hover:text-gray-400 focus:z-10 focus:outline-hidden focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150"
        >
